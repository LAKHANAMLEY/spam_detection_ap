class StringConstants {
  ...
  static const String enjoytext = 'Enjoy all the benifits of being an explorer member';
  ...
  static const String plztext = 'Please enter your valid phone number, We will send you a 4 digit code to verify.';
  ...
  static const String plsvalidtext = 'Please enter your valid phone number, We will send you a 4 digit code to verify.';
  static const String emailtext = 'Enter your email address for the verification process. We will send 4 digite code to your email.';
  ...
  static const String otpverifytext = 'Enter the 4 digit code that you received on your email';
  ...
  static const selectaccountext = 'Please select the type of account you will be setting up today.';
  ...
  static const securitytext='You Are Protected Against All The Dangerous Phone Numbers From Our Security Database';
  static const spamCalltext='All Spam Calls Are Currently Being Blocked From Calling Your Telephone Number, You May Miss Important Call If The Caller Number Is Flagged By The Network As Spam.';
}