...
class FamilyAddMemberEvent extends ApiEvent {
  ...
  @override
  List<Object?> get props => [email, firstName, lastName,relation,supportpin,phone,countrycode,password];
}
// edit member
class FamilyEditMemberEvent extends ApiEvent {
  ...
  @override
  List<Object?> get props => [ firstName, lastName,relation,supportpin,familyId];
}
// delete member
