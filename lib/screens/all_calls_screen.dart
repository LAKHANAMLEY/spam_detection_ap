            ...
            Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () {},
                        icon: Image.asset(IconConstants.icphonebold,height: MediaQuery.of(context).size.height*6/100,width: MediaQuery.of(context).size.width*6/100,),
             ...
             // SizedBox(height: MediaQuery.of(context).size.height*2/100,),
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset(IconConstants.icspamCircle,
                      height: MediaQuery
                          .of(context)
                          .size
                          .height * 6 / 100,),
                    ...
                    Expanded(
                      child:  Column(
                        crossAxisAlignment: CrossAxisAlignment
                            .start,
                        children: [
                          Text(StringConstants.smsdisabled,style: TextStyle(color: AppColor.primaryColor,
                          fontSize: 14,
                          ...
                          SizedBox(height: MediaQuery.of(context).size.height*2/100),
                          Text(StringConstants.smsautomaticallytext,style: TextStyle(color: AppColor.primaryColor,
                              fontSize: 12,
                              fontFamily: AppFont.fontFamily,
                              fontWeight: FontWeight.w600)
                          ),
                          ...
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(backgroundColor: AppColor.redColor,
                                minimumSize: Size(4, 40),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(
                                  12),)
                            ),
                              onPressed: (){}, child: Text('Enable Now',style: TextStyle(color: AppColor.secondryColor,fontSize: 16,fontFamily: AppFont.fontFamily,fontWeight: FontWeight.w600),))
                        ],
                      ),
                    ),
              ...
              ListView.builder(
                ...
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  final imageAvatar = listedItems[index]['imageAvatar']?? 'Unknown' ;
                  final iconCall = listedItems[index]['iconCall']?? 'Unknown';
                  final fullName = listedItems[index]['fullName']?? 'Unknown' ;
                  final callText= listedItems[index]['callText']?? 'Unknown' ;
                  return ListTile(
                    leading: Image.asset(
                      imageAvatar,
