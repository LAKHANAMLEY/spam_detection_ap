        ...
        listener: (context, state) {
          if (state is GetUserProfileState) {
            if (state.value.statusCode == 200) {
              SharedPref.saveUserData(User.fromJson(state.value.data));
              sharedPrefBloc.add(GetUserDataFromLocalEvent());
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            if (((user.planDetails?.title?.isEmpty ?? true) ||
                                user.planDetails?.title?.toLowerCase() ==
                                    "free")) {
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                10.width(),
                                Text(
                                  ((user.planDetails?.title?.isEmpty ?? true) ||
