...
class _FamilyMemberListState extends State<FamilyMemberList> {
  ...
  List<FamilyData> contacts = [];
  late List<FamilyData> filteredContacts;
  FamilyData? selectedCategory;
  bool isLoading = false;
  String? errorMessage;

  String? numberType;
  List<FamilyData> categories = [];
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              leading: Image.network(
                                filteredContacts[index].userRole!, //TODO: image path
                              ...
                              trailing: PopupMenuButton(
                                itemBuilder: (context) => [
                                  PopupMenuItem(
                                    ...
                                    onTap: () {
                                      Navigator.pushNamed(context, AppRoutes.familyEditMember);
