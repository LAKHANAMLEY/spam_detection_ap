    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title: GestureDetector(
              ...
              child: Image.asset(
                  ImageConstants.imageProfile, height: MediaQuery
                  .of(context)
                  .size
                  .height * 6 / 100),
            ),
            actions: [
              Image.asset(IconConstants.icNotification, height: MediaQuery
                  .of(context)
                  .size
                  .height * 3 / 100,),
              ...
              onTap: () {
                ...
                child: Image.asset(IconConstants.icMoreDetails, height: MediaQuery
                    .of(context)
                    .size
                    .height * 3 / 100,
                ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  SizedBox(height: MediaQuery
                      ...
                      .size
                      .height * 3 / 100),
                  Image.asset(IconConstants.securitykeyIcon, height: MediaQuery
                      .of(context)
                      .size
                      .height * 15 / 100,),
                  SizedBox(height: MediaQuery
          ...
          children: [
            Align(
              ...
              child: CircleAvatar(
                ...
                child: Image.asset(image,height: MediaQuery.of(context).size.height*4/100),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    title,
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: AppColor.callColor),
                  ),
                  SizedBox(height: 5),
                  Text(
                    description,
                    style: TextStyle(color: AppColor.ThumbColor, fontSize: 14),
                  ),
                ],
              ),
            ),
