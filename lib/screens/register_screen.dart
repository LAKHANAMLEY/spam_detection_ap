        ...
        leading:GestureDetector(
          ...
          child: Column(children: [
            ...
            const Center(
              ...
              style: TextStyle(color: AppColor.bluelightColor,
                  fontSize: 35,fontFamily: AppFont.fontFamily,
            ...
            SizedBox(
              ...
              child: TextFormField(
                readOnly: true,
                controller: dateofbirthController,//ese controller every field me assign karo
                decoration: InputDecoration(
            ...
            _isLoading
                ...
                : AppButton(text: StringConstants.registertext, onPress: () {
              ...
              if (email.isNotEmpty && password.isNotEmpty ) {
                ...
                signup(email: email, password: password,firstname:firstname,lastname: lastname,phonenumber: phone,dateofbirth: dob).then((response){
                  setState(() {
                    _isLoading = true;
                  });
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: const Text(StringConstants.logintext,
                      style: TextStyle(
                          fontSize: 15,
                          color: AppColor.yellowlightColor, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
            SizedBox(
