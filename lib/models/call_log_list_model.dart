...
CallLogListResponse callLogListResponseFromJson(String str) =>
    CallLogListResponse.fromJson(json.decode(str));

String callLogListResponseToJson(CallLogListResponse data) =>
