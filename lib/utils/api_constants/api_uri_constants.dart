...
class ApiUrlConstants {
  ...
  static String endPointEmailPassword = '$baseUrl/auth/login-with-email?lang=en';
  ...
  static String endPointForgotPasswordOTP = '$baseUrl/auth/forgetpassword-by-otp?lang=en';

  static String endPointResetPassword = '$baseUrl/auth/resetpassword?lang=en';

  static String endPointResetPasswordOTP = '$baseUrl/auth/resetpassword-by-otp?lang=en';
  ...
  static String endPointCorporateLogin = '$baseUrl/auth/corporate-login?lang=en';
  ...
  static String endPointDeleteCallLog = '$baseUrl/contacts/delete-call-log?lang=en';
  static String endPointDeleteAllCallLog = '$baseUrl/contacts/delete-all-call-log?lang=en';
